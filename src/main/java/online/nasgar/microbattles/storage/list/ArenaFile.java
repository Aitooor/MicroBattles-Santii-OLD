...
public class ArenaFile extends CoreFile {

    private final MicroBattles microBattles = MicroBattles.getInstance();

    final File file = new File(Bukkit.getPluginManager().getPlugin("MicroBattles").getDataFolder(), "arenas.yml");
    FileConfiguration configFile = null;

    public ArenaFile() {
        super("arenas.yml", DataType.FILE);
    }

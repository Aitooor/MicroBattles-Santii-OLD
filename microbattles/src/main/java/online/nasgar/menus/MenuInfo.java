...
public class MenuInfo implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender var1, Command var2, String var3, String[] var4) {
        if (!(var1 instanceof Player)) {
            ...
            if (var2.getName().equalsIgnoreCase("info")) {
                Menu info = new Menu("&8➢ &eInfo", 5);
                info.setInventoryOpened(c -> c.playSound(location, sonido, 1.0f , 1.0f));
                // info GENERAL
                info.registerButton(new MenuButton(new ItemBuilder(Material.PLAYER_HEAD)
